...
urlpatterns = [
    ...
    path('student/add/<int:pk>/<int:num>', views.add_session_student, name='add_session_student'),
    path('student/del/<int:pk>/<int:num>', views.del_session_student, name='del_session_student'),
    ...
    path('export/excel/sessions', views.export_sessions_excel, name='export_sessions_excel'),
